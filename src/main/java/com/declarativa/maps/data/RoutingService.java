...
public class RoutingService {
    ...
    private GraphHopper createGraphHopperInstance(String ghLoc) {
        ...
        graHopper.setProfiles(new Profile("foot").setVehicle("foot").setWeighting("fastest").setTurnCosts(false));

        // this enables speed mode for the profile we called car
        graHopper.getCHPreparationHandler().setCHProfiles(new CHProfile("foot"));
    ...
    public List<RoutingData> routing(List<GHPoint> points) {
